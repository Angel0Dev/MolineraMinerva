                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://es.wikipedia.org/wiki/ISO/IEC_9126" class="font-weight-bold" target="_blank">La iso 9126</a>
                        ...
                        <div class="col-lg-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://www.warthon-medina.com/molinera-minerva/" class="nav-link text-muted" target="_blank">Molinera Minerva</a>
                                </li>
                                <li class="nav-item">
